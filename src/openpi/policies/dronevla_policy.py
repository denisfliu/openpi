...
def make_dronevla_example() -> dict:
    ...
    return {
        ...
        "observation/3pov_2": np.random.randint(256, size=(224, 224, 3), dtype=np.uint8),
        "prompt": "do something",
    }
...
class DroneVLAInputs(transforms.DataTransformFn):
    ...
    def __call__(self, data: dict) -> dict:
        ...
        right_wrist_image = _parse_image(data["observation/3pov_2"])
        ...
        if "prompt" in data:
            inputs["prompt"] = "Pick up the chips and put them in the blue bin"
